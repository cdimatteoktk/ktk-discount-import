...
class Ktk_discount_import extends Module
{
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        ...
                        'desc' => $this->l('Separator to use while reading CSV file. This could be comma or semicolon'),
                        'name' => 'KTK_DISCOUNT_IMPORT_CSV_SEPARATOR_CHAR',
                        'label' => $this->l('CSV Columns Separator'),
                    ),
                    array(
                        'col' => 4,
                        'type' => 'text',
                        'prefix' => '<i class="icon"></i>',
                        'desc' => $this->l('Csv file to be imported. default NO_PATH.  DO NOT EDIT THIS FIELD '),
                        'name' => 'KTK_DISCOUNT_IMPORT_CSV_FILE_PATH_NUM',
                        'label' => $this->l('Csv file to be imported.'),
                    ),
                    array(
                        'col' => 4,
                        'type' => 'text',
                        'prefix' => '<i class="icon"></i>',
                        'desc' => $this->l('Row fore each import. DO NOT EDIT WHILE CRON IN PROGRESS'),
                        'name' => 'KTK_DISCOUNT_IMPORT_CSV_ROW_TO_SPLIT',
                        'label' => $this->l('Row fore each import'),
                    ),
                    array(
                        'col' => 4,
                        'type' => 'text',
                        'prefix' => '<i class="icon"></i>',
                        'desc' => $this->l('Folder splitted file.  DO NOT EDIT THIS FIELD '),
                        'name' => 'KTK_DISCOUNT_IMPORT_CRON_JOB_FILE_PATH_SPLIT',
                        'label' => $this->l('Folder splitted file'),
                    ),
                ),
                'submit' => array(
                    'title' => $this->l('Save'),
    ...
    protected function getConfigFormValues()
    {
        return array(
			...
			'KTK_DISCOUNT_IMPORT_CSV_FILE_PATH_NUM' =>  Configuration::get('KTK_DISCOUNT_IMPORT_CSV_FILE_PATH_NUM'),
